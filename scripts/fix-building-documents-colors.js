...
const filePath = path.join(__dirname, '../src/components/building/DocumentsList.tsx');
...
const replacements = [
  // Background colors
  { from: /bg-gray-900\/50/g, to: 'bg-card' },
  ...
  // Purple/primary colors and gradients
  { from: /bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white/g, to: 'bg-primary hover:bg-primary/90 text-primary-foreground' },
