...
const filePath = path.join(__dirname, '../src/components/documents/DocumentsList.tsx');

// Read the file
let content = fs.readFileSync(filePath, 'utf8');

// Count initial hardcoded colors
const initialColorCount = (content.match(/bg-gray-|text-gray-|border-gray-|text-white|bg-purple-|text-purple-|focus:border-purple-|focus:ring-purple-|hover:bg-gray-|hover:text-white|from-purple-|to-purple-|hover:from-purple-|hover:to-purple-|hover:bg-purple-|text-red-400|hover:bg-red-950|hover:text-red-300/g) || []).length;

console.log(`Found ${initialColorCount} hardcoded color instances in DocumentsList.tsx`);
...
const replacements = [
  ...
  { from: /bg-purple-600 hover:bg-purple-700 text-white/g, to: 'bg-primary hover:bg-primary/90 text-primary-foreground' },
  ...
  // Red/destructive colors for delete buttons
  { from: /text-red-400/g, to: 'text-destructive' },
  { from: /hover:bg-red-950/g, to: 'hover:bg-destructive/20' },
  { from: /hover:text-red-300/g, to: 'hover:text-destructive' },
...
const finalColorCount = (content.match(/bg-gray-|text-gray-|border-gray-|text-white|bg-purple-|text-purple-|focus:border-purple-|focus:ring-purple-|hover:bg-gray-|hover:text-white|from-purple-|to-purple-|hover:from-purple-|hover:to-purple-|hover:bg-purple-|text-red-400|hover:bg-red-950|hover:text-red-300/g) || []).length;

// Write the updated content back to the file
fs.writeFileSync(filePath, content, 'utf8');

const fixed = initialColorCount - finalColorCount;
console.log(`✅ Fixed ${fixed} hardcoded color instances in DocumentsList.tsx`);
...
console.log('🎉 General DocumentsList component updated!');