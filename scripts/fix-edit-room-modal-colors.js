...
const filePath = path.join(__dirname, '../src/components/building/EditRoomModal.tsx');
...
console.log(`Found ${initialColorCount} hardcoded color instances in EditRoomModal.tsx`);
...
console.log(`✅ Fixed ${fixed} hardcoded color instances in EditRoomModal.tsx`);
