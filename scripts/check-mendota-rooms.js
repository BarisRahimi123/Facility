...
async function checkMendotaHighSchool() {
  console.log('=== CHECKING MENDOTA HIGH SCHOOL ===\n');

  try {
    // Get Mendota High School facility
    ...
    // Get buildings for Mendota High School
    ...
    console.log('Rooms:', rooms.length);
      ...
      console.log('  💡 The user needs to add classrooms to see student capacity.');
      } else {
        rooms.forEach(room => {
