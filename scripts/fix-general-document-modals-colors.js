...
const replacements = [
  ...
  // File input specific colors
  { from: /file:bg-gray-700/g, to: 'file:bg-muted' },
  { from: /file:text-gray-300/g, to: 'file:text-foreground' },
...
files.forEach(fileName => {
  ...
  const initialColorCount = (content.match(/bg-gray-|text-gray-|border-gray-|text-white|bg-purple-|text-purple-|focus:border-purple-|focus:ring-purple-|hover:bg-gray-|hover:text-white|from-purple-|to-purple-|hover:from-purple-|hover:to-purple-|hover:bg-purple-|file:bg-gray-|file:text-gray-|placeholder:text-gray-/g) || []).length;
  ...
  const finalColorCount = (content.match(/bg-gray-|text-gray-|border-gray-|text-white|bg-purple-|text-purple-|focus:border-purple-|focus:ring-purple-|hover:bg-gray-|hover:text-white|from-purple-|to-purple-|hover:from-purple-|hover:to-purple-|hover:bg-purple-|file:bg-gray-|file:text-gray-|placeholder:text-gray-/g) || []).length;
...
console.log('🎉 All general document modals updated!');