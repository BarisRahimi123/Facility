...
// Import helper functions from DocumentsList
...
interface FacilityDocumentsListProps {
  facilityId: string;
  documents: Document[];
  onDocumentsChange?: () => void;
}

export function FacilityDocumentsList({ facilityId, documents, onDocumentsChange }: FacilityDocumentsListProps) {
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="h-8 w-8 p-0 bg-red-600 border-red-500 text-white hover:bg-red-500 hover:border-red-400"
                      title="Delete"
                    >
