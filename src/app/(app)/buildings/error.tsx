...
export default function BuildingsError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] p-6 text-center">
      <div className="max-w-md">
        <h1 className="text-3xl font-bold tracking-tight mb-4">Error loading buildings</h1>
        <p className="text-gray-600 mb-6">
          We're sorry, but there was an error loading the buildings page. Our team has been notified.
        </p>
